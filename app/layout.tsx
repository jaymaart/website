...
export const metadata: Metadata = {
	title: 'Jason Martin - Software Developer',
	description:
	...
	authors: [{ name: 'Jason Martin' }],
	creator: 'Jason Martin',
	openGraph: {
		title: 'Jason Martin - Software Developer Portfolio',
		...
		url: 'https://jdev.services',
		siteName: 'Jason Martin - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Jason Martin - Modern Minimal Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
